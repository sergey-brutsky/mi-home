...
public class XiaomiGateway2 : IDisposable
{
    ...
    private readonly Dictionary<Type, Action<MiHomeDevice>> _deviceEvents = [];
    ...
    private readonly ConcurrentDictionary<string, MiHomeDevice> _devicesList = new();
    ...
    public XiaomiGateway2(string gatewayPassword = null, string gatewaySid = null)
    {
    ...
    public XiaomiGateway2(Dictionary<string, string> namesMap, string gatewayPassword = null, string gatewaySid = null)
    ...
    public T GetDeviceBySid<T>(string sid) where T : MiHomeDevice
    {
        ...
        if (miHomeDevice is not T device)
        {
