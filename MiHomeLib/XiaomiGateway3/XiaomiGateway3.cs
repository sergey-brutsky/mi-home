...
using MiHomeLib.XiaomiGateway3.ActionProcessors;
using MiHomeLib.XiaomiGateway3.Devices;
using System.Threading.Tasks;

namespace MiHomeLib.XiaomiGateway3;
...
public class XiaomiGateway3 : MiioDevice, IDisposable
{
    ...
    public event Func<XiaomiGateway3SubDevice, Task> OnDeviceDiscoveredAsync = (_) => Task.CompletedTask;
