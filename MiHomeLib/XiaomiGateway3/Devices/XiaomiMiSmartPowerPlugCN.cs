...
{   
    ...
    public XiaomiMiSmartPowerPlugCN(string did, IMqttTransport mqttTransport, ILoggerFactory loggerFactory) : base(did, mqttTransport, loggerFactory)
    {
        Actions.Add(STATE_RES_NAME, async x =>
        {
