...
using static MiHomeLib.MqttGateway.JsonResponses.ZigbeeHearbeatResponse;
using static MiHomeLib.MqttGateway.JsonResponses.ZigbeeHearbeatResponse.ZigbeeHearbeatItem;

namespace MiHomeUnitTests;

public class MqttGatewayBaseTests : MqttGatewayDeviceTests
{
    private readonly string _gwDid = "397569381";
    private readonly Mock<MqttGatewayBase> _gw;

    public MqttGatewayBaseTests()
    {
        _devicesDiscoverer
        ...
        _gw = new Mock<MqttGatewayBase>(_gwDid, _miioTransport.Object, _mqttTransport.Object, _devicesDiscoverer.Object)
        {
            CallBase = true // this is important ! don't remove
        };
    }
