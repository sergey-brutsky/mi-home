...
public class XiaomiMultimodeGateway2BaseTests : MqttGatewayDeviceTests
{
    private const string GW_DID = "397569381";
    private readonly Mock<MultimodeGateway2Base> _gw;

    public XiaomiMultimodeGateway2BaseTests()
    {
        _gw = new Mock<MultimodeGateway2Base>(GW_DID, _miioTransport.Object, _mqttTransport.Object, _devicesDiscoverer.Object);        
    }
    ...
    {
        // Arrange
        var expected = MultimodeGateway2Base.AccessModeValue.Wireless2G;
    ...
    {
        // Arrange
        var expected = MultimodeGateway2Base.AccessModeValue.Wireless5G;
        SetupSetProperties();
