...
namespace MiHomeUnitTests.Miio;
...
public class MiRobotV1Tests: MiioDeviceTest
{
    ...
    public void ToString_Returns_Valid_State()
    {
        ...
        // Arrange
        var response = "{\"result\":[{\"msg_ver\":8,\"msg_seq\":54,\"state\":8,\"battery\":100,\"clean_time\":729,\"clean_area\":9795000,\"error_code\":0,\"map_present\":1,\"in_cleaning\":0,\"fan_power\":60,\"dnd_enabled\":0}],\"id\":6}";
